...
public final class EmployeeServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "proto.EmployeeService";
  ...
  private static volatile io.grpc.MethodDescriptor<proto.EmployeeOuterClass.Employee,
      proto.EmployeeOuterClass.saveEmployeeResponse> getAddEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addEmployee",
      requestType = proto.EmployeeOuterClass.Employee.class,
      responseType = proto.EmployeeOuterClass.saveEmployeeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.EmployeeOuterClass.Employee,
      proto.EmployeeOuterClass.saveEmployeeResponse> getAddEmployeeMethod() {
    io.grpc.MethodDescriptor<proto.EmployeeOuterClass.Employee, proto.EmployeeOuterClass.saveEmployeeResponse> getAddEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getAddEmployeeMethod = EmployeeServiceGrpc.getAddEmployeeMethod) == null) {
          EmployeeServiceGrpc.getAddEmployeeMethod = getAddEmployeeMethod =
              io.grpc.MethodDescriptor.<proto.EmployeeOuterClass.Employee, proto.EmployeeOuterClass.saveEmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.EmployeeOuterClass.Employee.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.EmployeeOuterClass.saveEmployeeResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<proto.EmployeeOuterClass.EmployeeRequest,
      proto.EmployeeOuterClass.deleteEmployeeStatus> getDeleteEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteEmployee",
      requestType = proto.EmployeeOuterClass.EmployeeRequest.class,
      responseType = proto.EmployeeOuterClass.deleteEmployeeStatus.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<proto.EmployeeOuterClass.EmployeeRequest,
      proto.EmployeeOuterClass.deleteEmployeeStatus> getDeleteEmployeeMethod() {
    io.grpc.MethodDescriptor<proto.EmployeeOuterClass.EmployeeRequest, proto.EmployeeOuterClass.deleteEmployeeStatus> getDeleteEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getDeleteEmployeeMethod = EmployeeServiceGrpc.getDeleteEmployeeMethod) == null) {
          EmployeeServiceGrpc.getDeleteEmployeeMethod = getDeleteEmployeeMethod =
              io.grpc.MethodDescriptor.<proto.EmployeeOuterClass.EmployeeRequest, proto.EmployeeOuterClass.deleteEmployeeStatus>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.EmployeeOuterClass.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  proto.EmployeeOuterClass.deleteEmployeeStatus.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void addEmployee(proto.EmployeeOuterClass.Employee request,
        io.grpc.stub.StreamObserver<proto.EmployeeOuterClass.saveEmployeeResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddEmployeeMethod(), responseObserver);
    }

    /**
     */
    default void deleteEmployee(proto.EmployeeOuterClass.EmployeeRequest request,
        io.grpc.stub.StreamObserver<proto.EmployeeOuterClass.deleteEmployeeStatus> responseObserver) {
  ...
  public static final class EmployeeServiceStub
    ...
    /**
     */
    public void addEmployee(proto.EmployeeOuterClass.Employee request,
        io.grpc.stub.StreamObserver<proto.EmployeeOuterClass.saveEmployeeResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
    ...
    /**
     */
    public void deleteEmployee(proto.EmployeeOuterClass.EmployeeRequest request,
        io.grpc.stub.StreamObserver<proto.EmployeeOuterClass.deleteEmployeeStatus> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class EmployeeServiceBlockingStub
    ...
    /**
     */
    public proto.EmployeeOuterClass.saveEmployeeResponse addEmployee(proto.EmployeeOuterClass.Employee request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    /**
     */
    public proto.EmployeeOuterClass.deleteEmployeeStatus deleteEmployee(proto.EmployeeOuterClass.EmployeeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class EmployeeServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.EmployeeOuterClass.saveEmployeeResponse> addEmployee(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<proto.EmployeeOuterClass.deleteEmployeeStatus> deleteEmployee(
        proto.EmployeeOuterClass.EmployeeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DELETE_EMPLOYEE:
          serviceImpl.deleteEmployee((proto.EmployeeOuterClass.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<proto.EmployeeOuterClass.deleteEmployeeStatus>) responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              proto.EmployeeOuterClass.Employee,
              proto.EmployeeOuterClass.saveEmployeeResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              proto.EmployeeOuterClass.EmployeeRequest,
              proto.EmployeeOuterClass.deleteEmployeeStatus>(
